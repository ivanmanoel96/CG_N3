...
public final class BoundingBox {
	...
	public void atribuirBoundingBox(Ponto4D ponto) {
		this.menorX = ponto.obterX();
		this.menorY = ponto.obterY();
		this.menorZ = ponto.obterZ();
		this.maiorX = ponto.obterX();
		this.maiorY = ponto.obterY();
		this.maiorZ = ponto.obterZ();
		processarCentroBBox();
	}
