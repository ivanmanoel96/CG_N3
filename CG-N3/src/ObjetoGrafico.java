...
public class ObjetoGrafico {
	...
	private Ponto4D veriticePosicionado;
//	= { 	
...
//	private double anguloGlobal = 0.0;
	...
	public ObjetoGrafico(double origemX, double origemY) {
		this.matrizObjeto = new Transformacao4D();
		this.vertices = new ArrayList<Ponto4D>();
		this.vertices.add(new Ponto4D(origemX, -origemY, 0, 1));
		this.vertices.add(new Ponto4D(origemX, -origemY, 0, 1));
		this.posicionarVertice(this.vertices.size() - 1);
	}
...
//		anguloGlobal = 0.0;
	...
	public void adicionaVertice(double origemX, double origemY) {
		this.vertices.add(new Ponto4D(origemX, -origemY, 0, 1));
		this.posicionarVertice(this.vertices.size() - 1);
	}
	
	private void posicionarVertice(int posicao) {
		this.veriticePosicionado = this.vertices.get(posicao);
	}
	
	public void atribuiXYVertice(double destinoX, double destinoY) {
		this.veriticePosicionado.atribuirX(this.veriticePosicionado.obterX() + destinoX);
		this.veriticePosicionado.atribuirY(this.veriticePosicionado.obterY() - destinoX);
	}
